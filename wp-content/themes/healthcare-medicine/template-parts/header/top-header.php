      ...
      <div class="col-lg-1 col-md-3 col-4 align-self-center">
        ...
        <?php if(class_exists('woocommerce')){ ?>
          <span class="cart_no infotext">
            ...
            <a href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_attr_e( 'shopping cart','healthcare-medicine' ); ?>"><i class="fas fa-shopping-bag"></i></a>
