...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <div class="page-box row">
    ...
    <div class="box-content">
      ...
      <p><?php $online_pharmacy_excerpt = get_the_excerpt(); echo esc_html( online_pharmacy_string_limit_words( $online_pharmacy_excerpt, esc_attr(get_theme_mod('online_pharmacy_excerpt_count','35')))); ?></p>
