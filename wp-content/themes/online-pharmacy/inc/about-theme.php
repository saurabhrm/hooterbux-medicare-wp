	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<p><a href="<?php echo esc_url( ONLINE_PHARMACY_SUPPORT_THEME_URL ); ?>" class="button button-primary"><?php esc_html_e( 'Support Forum', 'online-pharmacy' ); ?></a></p>
			</div>
				...
				<table>
					...
					<tbody>
						...
						<tr class="odd" scope="row">
							...
							<td class="feature feature--empty"></td>
							<td headers="comp-2" class="td-btn-2"><a class="sidebar-button single-btn" href="<?php echo esc_url(ONLINE_PHARMACY_PRO_THEME_URL);?>"><?php esc_html_e( 'Go for Premium', 'online-pharmacy' ); ?></a></td>
						</tr>
					</tbody>
				</table>
			</div>
